    ...
    try {
      ...
      const mappedOrders: Order[] = items.map((o: any) => {
        ...
        return {
          ...
          orderDate: o.order_date ? new Date(o.order_date).toLocaleDateString() : (o.created_at ? new Date(o.created_at).toLocaleDateString() : "—"),
          shipDate: o.ship_date ? new Date(o.ship_date).toLocaleDateString() : "—",
          deliveryDate: o.delivery_date ? new Date(o.delivery_date).toLocaleDateString() : "—",
